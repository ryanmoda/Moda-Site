...
(function () {
    ...
    app.config(function ($routeProvider){
        $routeProvider
			...
			.when('/cove',{
                templateUrl:'moda-cove.html?1623164400'
					...
					.when('/cove-cc',{
						templateUrl:'cove-cc.html?1623164400',
					})
					.when('/cove-dw',{
						templateUrl:'cove-dw.html?1623164400',
					})
			.when('/cove-ext',{
                templateUrl:'cove-ext.html?1623164400'
					...
					.when('/cove-cc-ext',{
						templateUrl:'cove-cc-ext.html?1623164400'
					})
					.when('/cove-dw-ext',{
						templateUrl:'cove-dw-ext.html?1623164400'
					})

					.when('/mmc-wl',{
						templateUrl:'mmc-wl.html?1626193817',
					})
					.when('/mmc-sc',{
						templateUrl:'mmc-sc.html?1627077885'
					})
					.when('/mmc-gd',{
			...
			.when('/mini-graze',{
				...
				.when('/mmg-sc',{
                templateUrl:'mmg-sc.html?1627077885'
            })
		    	.when('/mmg-gd',{
				...
				.when('/graze-wl',{
					...
					.when('/graze-dw-ext',{
						templateUrl:'graze-dw-ext.html?1623164400',
					})
				.when('/int-flex',{
			...
			//.when('/dmx-cntrl',{
                //templateUrl:'dmx-cntrl.html?1625585080'
           // })
					.when('/kandi-touch',{
						templateUrl:'kandi-touch.html?1623164400'
					})
          .when('/moda-touch',{
						templateUrl:'kandi-touch.html?1625585080'
					})
					.when('/tpc',{
		...
		//	.when('/dmx-accs',{
			...
			.when('/projects',{
                templateUrl:'projects.html?1623164400'
            })
        ...
        .when('/cathedral-st-john',{
          ...
          .when('/park-house',{
			...
			.when('/resources',{
                templateUrl:'resources.html?1623164400'
            })
			.when('/re-graze',{
			...
			.when('/reps',{
                templateUrl:'reps.html?1626801334'
            })
			.when('/news',{
			...
			.when('/careers',{
                templateUrl:'careers.html?1626386200'
			})
      .when('/job-description',{
                templateUrl:'job-description-Project-Manager.html?1626384776'
      })          
			.when('/job-description',{
                templateUrl:'job-description-Quotation-Specialist.html?1626386200'
      })          
			.when('/job-description',{
                templateUrl:'job-description2.html?1626384776'
              })          
      .when('/job-listings',{
               templateUrl:'job-listings-4.html?162705704'
})
			.when('/all-products',{
